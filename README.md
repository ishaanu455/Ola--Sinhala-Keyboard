...
**A fast, private, open-source Sinhala & English keyboard for Android — focused on Smart Phonetic Typing**
...
**Ola Keyboard** is a lightweight, privacy-respecting Android keyboard built around **Smart Phonetic Typing** — typing Sinhala naturally using English letters (Singlish), with intelligent word suggestions so you never have to think about a Sinhala key layout. This is the core focus of the project and where most of the development effort goes.

English typing and a basic Wijesekara (native Sinhala key layout) mode are also included for convenience, alongside a clean, modern settings screen for customizing everything from themes to typing behavior.

> **Note on Wijesekara:** Wijesekara support is a basic, best-effort layout. It is **not** the focus of this project and is not actively developed or bug-fixed here — several other dedicated apps already offer mature, well-maintained Wijesekara typing. If Wijesekara is your primary need, one of those may serve you better. Smart Phonetic Typing (Singlish) is where Ola Keyboard's attention is.
...
### ⌨️ Typing & Layouts
- **Smart Phonetic Typing (Singlish)** — the flagship feature: type Sinhala using English letters, with intelligent phonetic word suggestions
- **English** QWERTY layout
- **Wijesekara** — basic native Sinhala key layout *(not actively maintained — see note above)*
...
<p align="center">
  <img src="docs/screenshots/keyboard-singlish.png" width="220" />
...
```bash
git clone https://github.com/ishaanu455/Ola--Sinhala-Keyboard.git
cd Ola--Sinhala-Keyboard
...
Ola Keyboard was originally built on top of **[Fox Keyboard](https://github.com/xzunk/Foxkeyboard)** by **[xzunk (Madusanka)](https://github.com/xzunk)** — Sri Lanka's original open-source, privacy-first Sinhala keyboard for Android. Thank you to the original author for creating and open-sourcing the foundation this project was built from. ❤️

Please consider supporting the original project and its author's other open-source work.

## 📄 License

This project is licensed under the **GNU General Public License v3.0**, in keeping with the license of the Fox Keyboard project it was originally built on. See [`LICENSE`](LICENSE) for the full text.
